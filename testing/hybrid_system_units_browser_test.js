...
(async()=>{
 ...
 for(const command of ['enable','poweroff','validate_db','hup','expire_data']) for(const kind of ['success','error','network','redirect','html']){
  ...
  const queued=['hup','expire_data'].includes(command);
