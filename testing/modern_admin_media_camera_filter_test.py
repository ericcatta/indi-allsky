...
def test_modern_loop_uses_media_camera_filter_context():
    ...
    assert_true("v='modern-loop-preview-layout-v4'" in template, 'Loop template must cache-bust the responsive layout CSS')
...
def test_modern_loop_preview_layout_contains_media_without_forced_stretch():
    ...
    assert_true('width: 100%;\n  max-width: 100%;\n  height: clamp(320px, 42vw, 620px);' in css, 'Loop preview frame must be width-bounded with controlled height')
