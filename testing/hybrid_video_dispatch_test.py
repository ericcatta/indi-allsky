...
def run():
    with isolated_app(multi_camera=True) as app:
        ...
        cases += [(action,None,True) for action in ('backupDatabase','updateSatelliteTleData','systemHealthCheck','storagePressureCleanup')]
        ...
        print('Actual coordinator: 20 supported camera/global dispatch cases, missing-camera and unsupported rejection, persisted reasons, unchanged single-camera dispatch: PASS')
