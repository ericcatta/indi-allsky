    ...
    for name in ('views.py', 'classic_views.py'):
        for node in ast.walk(ast.parse((FLASK / name).read_text())):
            if (
                ...
                if node.args[0].value in ('/modern-admin/tools/camera-simulator', '/modern-admin/tools/generate', '/modern-admin/tools/image-circle-helper', '/modern-admin/tools/process-fits', '/modern-admin/tools/focus', '/modern-admin/system/gpio-control', '/modern-admin/storage/drives'):
                    ...
                    assert setting.value.value == {'/modern-admin/tools/camera-simulator':'modern_admin/camera_simulator.html', '/modern-admin/tools/generate':'modern_admin/generate.html', '/modern-admin/tools/image-circle-helper':'modern_admin/image_geometry.html', '/modern-admin/tools/process-fits':'modern_admin/image_processing.html', '/modern-admin/tools/focus':'modern_admin/focus.html', '/modern-admin/system/gpio-control':'modern_admin/manual_gpio.html', '/modern-admin/storage/drives':'modern_admin/drives.html'}[node.args[0].value]
