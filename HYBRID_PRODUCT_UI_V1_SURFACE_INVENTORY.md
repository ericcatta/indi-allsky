...
- Sky Cycle does not yet link directly to Highlights, Moment Detail, Output
  Detail, or Library.
- Library does not yet link directly to Observatory.
- These are navigation gaps, not blockers for the v1 skeleton.
- They should be addressed as a deliberate navigation pass, not by ad hoc links.
